package a.b.c.com.kbd.board.controller;
		...
		if ("I".equals(isudType)){
			...
			try{
				...
				if(bInsert) {
					...
					// Context 경로를 사용하지  않음		
					RequestDispatcher rd = request.getRequestDispatcher("/kbd/board/boardInsert.jsp");
					rd.forward(request, response);
				}else{
					out.println("<script>");
					out.println("location.href='/testKbd/kbd/board/board.html'");
					out.println("</script>");
				}
			}catch(Exception e) {
