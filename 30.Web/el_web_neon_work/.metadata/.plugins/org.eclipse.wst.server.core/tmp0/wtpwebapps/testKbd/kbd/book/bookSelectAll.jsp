<%@ page language="java" contentType="text/html; charset=EUC-KR" pageEncoding="EUC-KR"%>
    <%@page import="a.b.c.com.kbd.book.service.BookService"%>
<%@page import="a.b.c.com.kbd.book.service.BookServiceImpl"%>    
<%@page import="a.b.c.com.kbd.book.vo.BookVO"%>  
	...
	$(document).ready(function(){
		...
		function send(isudtype){
			...
			$("#bookSelectAllForm").attr({
				"action":"/testKbd/book?isudytpe="+isudtype,
				"method":"POST",
...
<tr>
	...
	<td class="tt"><img src="/testKbd/fileupload/book/<%= bvo.getBcover() %>" border="1" width="25" height="25" alt="image"></td>
