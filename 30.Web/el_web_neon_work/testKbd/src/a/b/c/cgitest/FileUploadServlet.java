...
public class FileUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String saveDirectory = "C:\\00.KOSMO93\\30.Web\\el_web_neon_work\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\testKbd\\fileupload";
		...
		try{
			...
			// MultipartRequest 클래스의 참조 변수를 이용해야 한다.
			...
			String file1 = String.valueOf(file.nextElement());
			fileName1 = mr.getFilesystemName(file1);
			String file2 = String.valueOf(file.nextElement());
			...
			if(aList !=null && aList.size() > 0){
				...
				//RequestDispatcher 인터페이스 에서 사용하는 getRequestDispatcher 함수에는
				//Context 경로를 사용하지 않음
				RequestDispatcher rd = request.getRequestDispatcher("/cgiTest/fileUpload.jsp");
				rd.forward(request, response);
			}else{
				out.println("<script>");
				out.println("location.href='testKbd/cgiTest/fileUpload.html'");
				out.println("</script>");
			}
