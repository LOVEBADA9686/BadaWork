...
study[] 배열의 0번지(인덱스) 값 : ${study[1] }<br />
study[] 배열의 0번지(인덱스) 값 : ${study[2] }<br />
study[] 배열의 0번지(인덱스) 값 : ${study[3] }<br />
study[] 배열의 0번지(인덱스) 값 : ${study[4] }<br />
study[] 배열의 0번지(인덱스) 값 : ${study[5] }<br />
study[] 배열의 0번지(인덱스) 값 : ${study[6] }<br />
<br /><hr><br />
[리스트를 받는 방법(JSP)]<br />
<%
...
ArrayList 배열의 0번지 값 : ${list[1] }<br/>
ArrayList 배열의 0번지 값 : ${list[2] }<br/>
ArrayList 배열의 0번지 값 : ${list[3] }<br/>
ArrayList 배열의 0번지 값 : ${list[4] }<br/>
<br /><hr><br />
