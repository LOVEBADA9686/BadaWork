...
public class KbdBoardChabun {
	...
	public static String gubunNum() {
		...
		try {
			...
			pstmt = conn.prepareStatement(KbdBoardSqlMap.getKbdBoardChabunQueryMap());
			System.out.println("게시판채번 쿼리 >>> \n" + KbdBoardSqlMap.getKbdBoardChabunQueryMap());
			...
			System.out.println("KbdBoardChabun gubunNum 디비 에러 >>> : " + e.getMessage());
		}finally {
			KbdConnProperty.conClose(conn, pstmt, rsRs);
		}
