...
//	}
	...
	public static String ymdNum() {
		...
		try {
			...
			pstmt = conn.prepareStatement(KbdMemberSqlMap.getKbdMemberChabunQuery());
			System.out.println("회원채번 쿼리 >>> \n" + KbdMemberSqlMap.getKbdMemberChabunQuery());
			...
			System.out.println("KbdMemberChabun ymdNum 디비 에러 >>> : " + e.getMessage());
		}finally {
			KbdConnProperty.conClose(conn, pstmt, rsRs);
		}
