...
public class KbdBoardrAll extends JFrame implements ActionListener{
...
//			});
		...
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			System.out.println("TableCell actionPerformen() 함수 진입 >>> : ");
			
			if(jb == e.getSource()) {
				String bnum = String.valueOf(jt.getValueAt(jt.getSelectedRow(), 0));
				System.out.println("bnum >>> : " + bnum);
				KbdBoardUpdate kbu = new KbdBoardUpdate();
...
//	######################################## 끝
	...
	public void kboardSelectAll() {
		System.out.println("KbdMemberAll kboardSelectAll() 함수 진입 >>> : ");
	...
	public void kboardSelectSubject(String searchStr) {
		System.out.println("KbdMemberAll kmemWSelectName() 함수 진입 >>> : ");
	...
	// JTable 프린트
	public void jtablePrint(ArrayList<KbdBoardVO> aList, int rowCnt, int columnCnt) {
		System.out.println("KbdMemberAll jtablePrint() 함수 진입 >>> : ");
