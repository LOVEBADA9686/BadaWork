...
public class KbdBoardScr {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 2 : 
				try {
					String sVal2[] = KbdBoardScr.getParameter(2);
					KbdBoardScr.kboardSelect(sVal2);
				}catch (Exception e) {
				}
				break;
			...
			case 3 :
				try {
					String sVal3[] = KbdBoardScr.getParameter(3);
					KbdBoardScr.kboardInsert(sVal3);
				}catch(Exception e) {
				}
				break;
			...
			case 4 :
				try {
					String sVal4[] = KbdBoardScr.getParameter(4);
					KbdBoardScr.kboardUpdate(sVal4);
				}catch(Exception e) {
				}
				break;
			...
			case 5 :
				try {
					String sVal5[] = KbdBoardScr.getParameter(5);
					KbdBoardScr.kboardDelete(sVal5);
				}catch(Exception e) {
				}
				break;
			}
