...
--PK, FK 등 제약조건은 및 오브젝트는 복사 되지 않는다.
...
-- DESC DEPT01; -> DEPT01테이블에 각 칼럼의 입력데이터값 사이즈 확인 할수 있음
-- DNAME 컬럼의 사이즈가 14보다 입력데이터값이 커서 에러남
...
INSERT INTO DEPT01
VALUES (41, 'OPERATIONS', NULL);

INSERT INTO DEPT01
VALUES (42, 'OPERATIONS', '');
...
INSERT INTO EMP01
VALUES (4001, 'AA01', TO_DATE('2021/08/06', 'YYYY-MM-DD'), 10);
...
-- 테이블을 생성하고 컬럼에 데이터를 입력하지 않은 상태는 항상 NULL 이다.
...
-- UPDATE : UPDATE 는 기본적으로 INSERT 보다 수행시간이오래걸린다.
--UPDATE 테이블이름
--SET 컬럼이름=컬럼값, ....n
--WHERE 조건
